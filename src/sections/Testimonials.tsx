            ...
            {[...testimonials, ...testimonials].map((testimonial) => (
              ...
              >
                ...
                <div className="flex items-center gap-3 mt-5">
                  <div className="relative after:content-[''] before:content-[''] before:absolute before:inset-0 before:border before:border-white/30 before:z-10 before:rounded-lg after:absolute after:inset-0 after:bg-[rgb(140,69,244)] after:mix-blend-soft-light after:rounded-lg">
                    <Image
